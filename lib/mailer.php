...
class Mailer {
    ...
    ***********************************/
    ############################################################################
        ...
        //            if (!mail($mail['to'],$mail['subject'],$mail['body'],$mail['headers'], "-f$from")){
        //                $error = "Y";
        //            }#end if
        //
        //            #if error try without the additional parameter passed
        //            if ($error == 'Y') {
