...
var SqueezeBox = {
	...
	initialize: function(presets) {
		...
		this.problemtags = $$('select','textarea');
	...
	close: function(e) {
		...
		this.problemtags.setStyle('display', '');
		return this;
	},
	...
	setContent: function(handler, content) {
		...
		var size = window.getScrollSize(), scroll = document.getScroll();
		...
		this.problemtags.setStyle('display', 'none');
